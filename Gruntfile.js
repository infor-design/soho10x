...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
	...
	copy: {
		main: {
			files: [
				{expand: true, flatten: true, src: ['Controls/lib/d3.min.js', 'Controls/lib/jquery-3.7.1.min.js', 'Controls/lib/jquery-1.11.1.min.map', 'Controls/lib/jquery-ui-1.10.4.custom.min.js', 'Controls/inforFavicon/favicon.ico'], dest: 'Controls/Release', filter: 'isFile'}
			]
		}
	},
	cssmin: {
